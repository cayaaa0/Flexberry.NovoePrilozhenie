...
namespace IIS.Novoe_prilozhenie
{
    ...
    [View("Услуга", new string[] {
            "НомерУсл as \'ID услуги\'",
    ...
    [View("Услуга", new string[] {
            ...
            "Длительность as \'Длительность\'",
            "Стоимость as \'Стоимость\'"})]
    [AssociatedDetailViewAttribute("Услуга", "ЗапОбУсл", "ЗапОбУслE", true, "", "Запись об услуге", true, new string[] {
            ""})]
    public class Услуга : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Novoe_prilozhenie.Услуги fНаименование;
        
        private string fДлительность;
        
        private IIS.Novoe_prilozhenie.Стоимость fСтоимость;
        
        private IIS.Novoe_prilozhenie.DetailArrayOfЗапОбУсл fЗапОбУсл;
        ...
        public virtual IIS.Novoe_prilozhenie.Услуги Наименование
        {
            get
            {
                ...
                IIS.Novoe_prilozhenie.Услуги result = this.fНаименование;
        ...
        public virtual IIS.Novoe_prilozhenie.Стоимость Стоимость
        {
            get
            {
                ...
                IIS.Novoe_prilozhenie.Стоимость result = this.fСтоимость;
        ...
        public virtual IIS.Novoe_prilozhenie.DetailArrayOfЗапОбУсл ЗапОбУсл
        {
            get
            {
                ...
                {
                    this.fЗапОбУсл = new IIS.Novoe_prilozhenie.DetailArrayOfЗапОбУсл(this);
                }
                IIS.Novoe_prilozhenie.DetailArrayOfЗапОбУсл result = this.fЗапОбУсл;
        ...
        public class Views
        {
            ...
            /// "Услуга" view.
            /// </summary>
            public static ICSSoft.STORMNET.View Услуга
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Услуга", typeof(IIS.Novoe_prilozhenie.Услуга));
                }
            }
            ...
            /// "Услуга" view.
            /// </summary>
            public static ICSSoft.STORMNET.View Услуга2
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Услуга", typeof(IIS.Novoe_prilozhenie.Услуга));
