...
namespace IIS.Novoe_prilozhenie
{
    ...
    [View("Паркомат", new string[] {
            "НомерПарк as \'ID паркомата\'",
            "Терминал as \'Терминал\'",
            "Терминал.НомерТер as \'Номер терминала\'",
            "Услуга as \'Услуга\'",
            "Услуга.Длительность as \'Длительность\'",
            "Шлагбаум as \'Шлагбаум\'",
            "Шлагбаум.НомерШлаг as \'Номер шлагбаума\'",
            "Парковка.Адрес as \'Адрес\'"}, Hidden=new string[] {
            "Терминал.НомерТер",
            "Услуга.Длительность",
            "Шлагбаум.НомерШлаг"})]
    [MasterViewDefineAttribute("Паркомат", "Терминал", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерТер")]
    [MasterViewDefineAttribute("Паркомат", "Услуга", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Длительность")]
    [MasterViewDefineAttribute("Паркомат", "Шлагбаум", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "НомерШлаг")]
    public class Паркомат : ICSSoft.STORMNET.DataObject
    {
        
        private int fНомерПарк;
        
        private IIS.Novoe_prilozhenie.Терминал fТерминал;
        
        private IIS.Novoe_prilozhenie.Услуга fУслуга;
        
        private IIS.Novoe_prilozhenie.Шлагбаум fШлагбаум;
        
        private IIS.Novoe_prilozhenie.Парковка fПарковка;
        ...
        [PropertyStorage(new string[] {
                "Терминал"})]
        [NotNull()]
        public virtual IIS.Novoe_prilozhenie.Терминал Терминал
        {
            get
            {
                ...
                IIS.Novoe_prilozhenie.Терминал result = this.fТерминал;
        ...
        [PropertyStorage(new string[] {
                "Шлагбаум"})]
        [NotNull()]
        public virtual IIS.Novoe_prilozhenie.Шлагбаум Шлагбаум
        {
            get
            {
                ...
                IIS.Novoe_prilozhenie.Шлагбаум result = this.fШлагбаум;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Novoe_prilozhenie.Парковка.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "Парковка"})]
        public virtual IIS.Novoe_prilozhenie.Парковка Парковка
        {
            get
            {
                ...
                IIS.Novoe_prilozhenie.Парковка result = this.fПарковка;
        ...
        public class Views
        {
            ...
            /// "Паркомат" view.
            /// </summary>
            public static ICSSoft.STORMNET.View Паркомат
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("Паркомат", typeof(IIS.Novoe_prilozhenie.Паркомат));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПаркомат : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Novoe_prilozhenie.DetailArrayOfПаркомат members)

        // *** End programmer edit section *** (IIS.Novoe_prilozhenie.DetailArrayOfПаркомат members)
        ...
        /// </summary>
        public DetailArrayOfПаркомат(IIS.Novoe_prilozhenie.Парковка fПарковка) : 
                base(typeof(Паркомат), ((ICSSoft.STORMNET.DataObject)(fПарковка)))
        {
        }
        
        public IIS.Novoe_prilozhenie.Паркомат this[int index]
        {
            get
            {
                return ((IIS.Novoe_prilozhenie.Паркомат)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Novoe_prilozhenie.Паркомат dataobject)
        {
